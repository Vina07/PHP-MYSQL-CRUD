...
<div style="text-align:right; margin-top:5px; margin-right:5px;">Member only page - Welcome <?php echo $_SESSION['username']; ?> &nbsp;&nbsp;&nbsp;<a href='logout.php'>Logout</a></div>
...
<div>
  <p align="center"><strong>Members Home Page </strong></p>
  <p align="center">This is where you create your members only pages, each has some php inserted to redirect anyone not logged in to your home logon.php page.</p>
